  ...
  return (
    <>
      <section className="service-section py-24">
        ...
        <p
          className="w-80 lg:w-96 mx-auto text-[#8e8e8e] lg:mt-16 mt-6 text-center"
          data-aos="fade-up"
        >
          A skilled team is ready to provide any digital support to get your
          startup running right away.
        </p>
        <div className="lg:px-48 px-4 lg:mt-24 mt-16">
          <div className="grid lg:grid-cols-3 grid-cols-1 gap-9 mt-9 font-sans">
            {services.map((service) => {
              return (
                <div
                  className={`bg-white  lg:p-7 p-5 rounded-md group hover:-translate-y-4 transition-all duration-300 ${service.hoverClass} cursor-pointer`}
                  key={service._id}
                  data-aos="zoom-in"
                >
                  ...
                  <div className="text-center">
                    <h1 className="text-2xl mb-4 text-black font-bold group-hover:text-white">
                      {service.name}
                    </h1>
