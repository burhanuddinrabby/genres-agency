        ...
        <div className=" lg:px-48 px-4 lg:mt-[140px] mt-[30px]">
            <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-16 gap-4 font-poppins z-10 mx-auto lg:px-60">
                <div className="lg:p-7 p-5 rounded-md">
                    <div className="bg-white w-[57px] h-[57px] text-2xl rounded-lg text-primary grid justify-center items-center ml-2 mb-5">
                        <FontAwesomeIcon icon={faPhone} />
                    </div>
                    <div>
                        <h1 className="text-2xl mb-4 text-black font-bold">Phone:</h1>
                        <p className="text-sm text-[#8E8E8E] w-[82%]">+880171122-334455</p>
                        <p className="text-sm text-[#8E8E8E] w-[82%] mt-2">+880171122-334455</p>
                    </div>
                </div>
                <div className="lg:p-7 p-5 rounded-md">
                    <div className="bg-white w-[57px] h-[57px] text-2xl rounded-lg text-primary grid justify-center items-center ml-2 mb-5">
            ...
            <div className="text-center mt-10">
                ...
                <div className="grid lg:grid-cols-3 gap-4 grid-cols-1 w-[60%] mx-auto py-12">
            ...
            <p className='text-center text-[#8e8e8e] py-28'>
