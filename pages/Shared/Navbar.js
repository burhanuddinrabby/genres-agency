...
const Navbar = () => {
    const menuItemStyle = 'text-[#FFFFFF] md:text-[#8E8E8E] font-normal hover:bg-transparent hover:text-primary transition-all duration-300'
    const menuItems = <>
        ...
        <div className="navbar text-black lg:min-w-7xl lg:px-48 lg:flex justify-between">
            <div className="navbar-center w-full flex justify-between">
                <div className="dropdown md:hidden">
                    ...
                    <ul tabIndex="0" className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-gradient-to-r from-primary to-secondary text-[#fff] rounded-box w-[90vw]">
                        {menuItems}
                    </ul>
                </div>
