        ...
        <div className='text-center'>
            ...
            <p className='text-[#8E8E8E] text-left mt-12 mb-24 text-xl'>
                ...
                <blockquote>
                    ...
                    - <span className='font-semibold'>&quot;No, my dear friend. There is no such custom. I was doing my nation&apos;s official work when you entered and the lamp&apos;s oil was from National treasure&apos;s money. <br />
                ...
                What do you need to turn an idea into an actual product/service!? <br />
                ...
                <button className='btn rounded-none px-12 bg-gradient-to-r from-primary to-secondary text-[#fff] border-none block lg:mt-20 mt-5'>
                    Create a package
                </button>
